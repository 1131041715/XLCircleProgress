...
-(void)buildLayout
{
    ...
    //创建贝塞尔路径  startAngleq起始角度  endAngle结束角度 角度注意正负
    UIBezierPath *path = [UIBezierPath bezierPathWithArcCenter:CGPointMake(centerX, centerY) radius:radius startAngle:(-1.5f*M_PI) endAngle:0.5f*M_PI clockwise:YES];
    ...
    //背景圆环颜色
    backLayer.strokeColor  = [UIColor purpleColor].CGColor;
...
//    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[RGB(255, 151, 10) CGColor],(id)[RGB(255, 203, 0) CGColor], (id)[RGB(255, 120, 0) CGColor],nil]];
////    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[UIColor greenColor].CGColor,(id)[UIColor greenColor].CGColor, nil]];
